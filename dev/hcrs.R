tier3 <- function(ref_pts, naa, dem_params, avgrec, cutoff_age=1, hyperallometry=1){
...
mp_f40_hybrid$hcr$extra_options$harvest_cap <- 20
...
mp_f00chr$ref_points$spr_target <- c(1.00, 0.001)
